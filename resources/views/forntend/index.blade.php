        ...
        <div class="row">
          <div class="col-md-6 tn-left">
            <div class="row tn-slider">
              <div class="col-md-6">
                <div class="tn-img">
                  <img src="{{ asset('assets/forntend/img/news-450x350-1.jpg') }}" />
                  <div class="tn-title">
              ...
              <div class="col-md-6">
                <div class="tn-img">
                  <img src="{{ asset('assets/forntend/img/news-450x350-2.jpg') }}img/news-450x350-2.jpg" />
                  <div class="tn-title">
                    <a href=""
          ...
          <div class="col-md-6 tn-right">
            <div class="row">
              <div class="col-md-6">
                <div class="tn-img">
                  <img src="{{ asset('assets/forntend/img/news-350x223-1.jpg') }}" />
                  <div class="tn-title">
              ...
              <div class="col-md-6">
                <div class="tn-img">
                  <img src="{{ asset('assets/forntend/img/news-350x223-2.jpg') }}" />
                  <div class="tn-title">
                    <a href="">Lorem ipsum dolor sit</a>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="tn-img">
                  <img src="{{ asset('assets/forntend/img/news-350x223-3.jpg') }}" />
                  <div class="tn-title">
                    <a href="">Lorem ipsum dolor sit</a>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="tn-img">
                  <img src="{{ asset('assets/forntend/img/news-350x223-4.jpg') }}" />
                  <div class="tn-title">
                    <a href="">Lorem ipsum dolor sit</a>
                  </div>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="row cn-slider">
              ...
              <div class="col-md-6">
                <div class="cn-img">
                  <img src="{{ asset('assets/forntend/img/news-350x223-5.jpg') }}" />
                  <div class="cn-title">
                    <a href="">Lorem ipsum dolor sit</a>
                  </div>
                </div>
