...
@csrf
    <div class="input-group">
        ...
        <select name="keyword"
            id="Keyword"
            class="custom-select bg-light border-0 small">
...
@can('notifaction')
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                           ...
                           @forelse ( Auth::guard('admin')->user()->unreadNotifications as $notify )
                                    <a class="dropdown-item d-flex align-items-center" href="{{ $notify->data['link'] }}?notifyadmin={{ $notify->id }}">
                                    <div class="mr-3">
...
@endcan
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('admin.porfile.index') }}">
